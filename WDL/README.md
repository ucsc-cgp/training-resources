...
- [The WDL Library](#the-wdl-library)
  ...
  * [Recipes](#recipes)
    ...
    + [Optional and default inputs with select_first](#optional-and-default-inputs-with-select-first)
  ...
  * [Good Practices](#good-practices)
    + [Maximize reproducibility by knowing what scripts will be run](#maximize-reproducibility-by-knowing-what-scripts-will-be-run)
  * [Runtime Attributes](#runtime-attributes)
    ...
    + [If at first you don't succeed, set maxRetries](#if-at-first-you-don-t-succeed--set-maxretries)
    + [Cromwell can handle preemptible interruptions for you](#cromwell-can-handle-preemptible-interruptions-for-you)
    + [Some runtime attributes must use integers and/or strings](#some-runtime-attributes-must-use-integers-and-or-strings)
  * [Different versions of WDL](#different-versions-of-wdl)
    + [Some functions have changed in in WDL 1.0](#some-functions-have-changed-in-in-wdl-10)
    + [Cromwell lags behind the current WDL spec](#cromwell-lags-behind-the-current-wdl-spec)
  * [Miscellaneous](#miscellaneous)
    ...
    + [Try a new WDL executor](#try-a-new-wdl-executor)
  * [Terra-specific Tips](#terra-specific-tips)
    + [General data access issues on Terra](#general-data-access-issues-on-terra)
      ...
      - [Use gs rather than https inputs](#use-gs-rather-than-https-inputs)
